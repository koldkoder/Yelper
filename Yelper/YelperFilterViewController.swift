//
//  YelperFilterViewController.swift
//  Yelper
//
...
@objc protocol YelperFilterViewControllerDelegate {
    optional func filterViewController(filterViewController: YelperFilterViewController, didUpdateFilters filters: [String:AnyObject])
}

class YelperFilterViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate {
